...
This directory tracks the product-facing plan for the commercial MVP after recovery, governance reconciliation, launch-readiness rehearsal, and bounded runtime metadata Phase `I1`.

## Current Position

- Canonical recovery is closed.
- Registry reconciliation for `M-001..M-055` is closed.
