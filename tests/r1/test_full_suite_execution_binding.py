...
def test_binding_resolves_commit_tree_and_clean_worktree():
    ...
    # This checkout is intentionally dirty while the test file is being added;
    # the binding must fail closed rather than hide that state.
    assert b['status']=='invalid'; assert 'working_tree_clean' in b['reason_codes']
